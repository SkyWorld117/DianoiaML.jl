...
let
    ...
    Minibatch_Gradient_Descent.fit(sequential=model, input_data=data, output_data=data2, loss_function=Absolute_Loss, monitor=Absolute_Loss, learning_rate=0.02, epochs=10, mini_batch=32)
end
