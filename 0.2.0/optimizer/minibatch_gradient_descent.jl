...
module Minibatch_Gradient_Descent
    ...
    function fit(;sequential::Any, input_data::Array{Float32}, output_data::Array{Float32}, loss_function::Any, monitor::Any, learning_rate::Float64=0.01, epochs::Int64=20, mini_batch::Real=32)
