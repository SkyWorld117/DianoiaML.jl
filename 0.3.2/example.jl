...
@time begin
    ...
    Minibatch_GD.fit(sequential=model, input_data=flatten(train_x, 3), output_data=One_Hot(train_y, 10, dict), loss_function=Cross_Entropy_Loss, monitor=Classification, epochs=50, batch=128)
end
