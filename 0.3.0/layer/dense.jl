module dense
    mutable struct Dense
        ...
        function Dense(;input_size::Int64, layer_size::Int64, activation_function::Module, randomization::Bool=true, reload::Bool=false)
            ...
            if randomization
                limit = sqrt(6 / (input_size + layer_size))
                weights = Array{Float32}(rand(-limit:0.00001:limit, (layer_size, input_size)))
                biases = Array{Float32}(rand(-limit:0.00001:limit, layer_size))
            else
