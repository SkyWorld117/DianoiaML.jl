module dense
    mutable struct Dense
        ...
        function Dense(;input_size::Int64, layer_size::Int64, activation_function::Module, randomization::Bool=true, reload::Bool=false)
            ...
            new(save_Dense, load_Dense, activate_Dense, PU_Dense, true, true, input_size, layer_size, activation_function, weights, biases, weights_prop, biases_prop)
        end
    end
    ...
    function PU_Dense(weights::Array{Float32}, ∇biases::Array{Float32})
