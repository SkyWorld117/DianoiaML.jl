...
function incomplete_init(name::String)
    ...
    elseif name=="Convolutional_2D"
        return Convolutional_2D(reload=true, input_filter=0, filter=0, input_size=0, input2D_size=(0,0), kernel_size=(0,0), activation_function=None)
    elseif name=="MaxPooling_2D"
        return MaxPooling_2D(reload=true, input_filter=0, input_size=0, input2D_size=(0,0), kernel_size=(0,0), activation_function=None)
    end
end
